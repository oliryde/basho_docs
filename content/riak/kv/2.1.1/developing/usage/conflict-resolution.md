...
[central goals]: /riak/kv/2.1.1/learn/why-riak-kv

One of Riak's [central goals] is high availability. It was built as a [clustered](/riak/kv/2.1.1/learn/concepts/clusters) system in which any [node](/riak/kv/2.1.1/learn/glossary/#node) is capable of receiving requests without requiring that
...
[sibling explosion](/riak/kv/2.1.1/using/performance/latency-reduction-checklist#siblings), which can
...
the entire node. Other issues include [increased cluster latency](/riak/kv/2.1.1/using/performance/latency-reduction-checklist) as the object is replicated and out-of-memory errors.
