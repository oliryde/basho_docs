...
[central goals]: /riak/kv/2.0.4/learn/why-riak-kv

One of Riak's [central goals] is high availability. It was built as a [clustered](/riak/kv/2.0.4/learn/concepts/clusters) system in which any [node](/riak/kv/2.0.4/learn/glossary/#node) is capable of receiving requests without requiring that
